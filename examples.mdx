...
本页展示了各种 Model Context Protocol (MCP) 服务器，用于演示协议的功能和多样性。这些服务器使大型语言模型(LLMs)能够安全地访问工具和数据源。

## 参考实现

这些官方参考服务器展示了 MCP 的核心功能和 SDK 用法:
...
- **[Obsidian Markdown Notes](https://github.com/calclavia/mcp-obsidian)** - 在 Obsidian 知识库中读取和搜索 Markdown 笔记
...
> **注意:** 社区服务器未经测试，使用风险自负。它们不隶属于 Anthropic 也未得到其认可。
...
访问我们的 [GitHub Discussions](https://github.com/orgs/modelcontextprotocol/discussions) 参与 MCP 社区讨论。
