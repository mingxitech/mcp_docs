...
提示词使服务器能够定义可重用的提示词模板和工作流，客户端可以轻松地将其展示给用户和 LLMs。它们提供了一种强大的方式来标准化和共享常见的 LLM 交互。

<Note>
  提示词设计为**用户控制**，这意味着它们从服务器暴露给客户端时，用户能够明确地选择使用它们。
</Note>
    ...
    },
    {
      ...
      "content": {
        ...
        "resource": {
          ...
          "text": "[2024-03-14 15:32:11] 错误：连接超时 in network.py:127\n[2024-03-14 15:32:15] 警告：重试连接 (尝试 2/3)\n[2024-03-14 15:32:20] 错误：达到最大重试次数",
          "mimeType": "text/plain"
        }
      }
    },
